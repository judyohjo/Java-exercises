public class MyCylinder {
	...
	public String toString() {
		return String.format("MyCylinder:height=%d, %s", this.height, base.toString());
	}
	
	public double getVolume() {
		double volume = Math.PI * (base.getRadius() * base.getRadius()) * this.height;
		return volume;
	}
	
	public double getSurfaceArea() {
		double surfaceArea = (2 * Math.PI * base.getRadius() * this.height) + (2 * Math.PI * (base.getRadius() * base.getRadius()));
		return surfaceArea;
	}
}
